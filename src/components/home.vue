    ...
    <div>
      <div class="btn-body-status">
        <div>
          {{
            voice.name
              ? $t("action.playing") + $t("voice." + voice.name)
              : $t("action.noplay")
          }}
        </div>
      ...
      <div class="cate-ctrldft">
        <a @click="cate()" style="text-decoration: none; color: #fff"
          ><img
            ...
            style="width: 35px; margin-left: -8px"
          />{{ $t("action.choose") }}</a
        ><br />
        <div id="cate" style="display: none">
          <button
            style="margin-top: 2.5px; margin-bottom: 2.5px"
            class="btn btn-ctrldft"
...
.btn-new:focus {
  ...
  box-shadow: inset 5px 5px 10px #3c3c3c, inset -5px -5px 10px #606060;
  background: #ff7c7c;
}
.btn-new:hover {
